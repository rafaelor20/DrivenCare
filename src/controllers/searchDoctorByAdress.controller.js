...
export async function getDoctorsByAddress(req, res) {
  ...
  try {
    ...
    // Query the database to find the doctors with the given address
    const searchQuery = `SELECT * FROM doctors WHERE address ILIKE '%${address}%'`;
